    ...
    const Form = () => (
        <Animated.View style={[formStyles.formContainer, { transform: [{ translateY }] }]}>
            ...
            <MaterialIcons name='close' size={22} onPress={() => setFormRVisible(false)}
                ...
                <TextInput keyboardType='numeric' placeholder='00.00' style={{fontSize: 28}}/><Text style={{fontSize: 28}}>GGP</Text>
                </View>
                <View style={{flexDirection: 'row', alignItems: 'center', margin: 30, marginLeft: 80}}>
                <TextInput keyboardType='numeric' value='00.00' editable={false} style={{fontSize: 28}}/><Text style={{fontSize: 28}}>$USD</Text>
                </View>
