...
const App = ({userData, updateTotalGgp}) => {
    ...
    return (
      ...
      <Text style={styles.balanceBox} className='balance-box'>Balance: {userData ? userData.wallet.totalggp : 0}</Text>
      <View style={stylesBlackjack.cardsContainer}>
        <Game coins={userData ? userData.wallet.totalggp : 0} setCoins={setCoins} updateTotalGgp={updateTotalGgp}/>
      </View>
    </LinearGradient>
    );
};
